...
Ainda não há código neste repositório. Ao ser criado, o schema/validador deve viver em algo como `src/features/import-export/schema.ts` (planejado). A skill de geração já existe: `.claude/skills/gerar-diagrama-classmap/SKILL.md`.
